...
- [ ] **Phase 1: Foundation (Nền móng)** - *Đang thực hiện (Hoàn thành ~80%)*
- [ ] **Phase 2: Utilities (Tiện ích lập trình)** - *Sắp thực hiện*
...
- [ ] Xây dựng hệ thống Log tập trung (`src/utils/logger.ts`) ghi ra VS Code Output Channel
...
- [ ] **Sinh mã ngẫu nhiên:**
  - [ ] Sinh mã UUID v4 chèn trực tiếp tại con trỏ chuột
  - [ ] Sinh chuỗi ký tự ngẫu nhiên (chữ, số, ký tự đặc biệt) theo độ dài yêu cầu
- [ ] **Bộ chuyển đổi định dạng chữ (Case Converter):**
  - [ ] Chuyển đổi vùng chọn sang `camelCase`
  - [ ] Chuyển đổi vùng chọn sang `snake_case`
  - [ ] Chuyển đổi vùng chọn sang `PascalCase`
